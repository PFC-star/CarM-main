...
def experiment(final_params):
    ...
    for num_run in range(runs):
        ...
        num_task = final_params.num_task_cls_per_task[0]  # 5
        num_classes_per_task = final_params.num_task_cls_per_task[1] # 2
        ...
        dataset = iCIFAR10('../datasets')
        for task_id in range(num_task):
            label_st = task_id
            for x in range(label_st, label_st + 6 ):
                print(class_order[x])
