...
class PureER(Base):
    ...
    def before_train(self, task_id,domain=1):
        
        self.curr_task_iter_time = []
        self.model.eval()
        self.stream_dataset.create_task_dataset(task_id,domain=domain)
        self.test_dataset.append_task_dataset(task_id,domain=domain)
